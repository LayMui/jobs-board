    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-md p-8">
      ...
      <div class="text-gray-800 leading-7">
        ...
        <ul class="list-disc list-inside">
          <li>Design and build automated software for our internal microservices and apps</li>
          <li>Architect and implement the backend of internal and external React applications</li>
          <li>Support automation of Passio's ML and AI deployment pipelines</li>
          <li>Build and maintain microservices, processes and databases on GCP and AWS</li>
          <li>Build fast scalable APIs for internal and external consumption</li>
        </ul>

        <button class="mt-5 bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded text-xs">Apply for this position</button>
      </div>
    </div>
  </div>
</div>  
